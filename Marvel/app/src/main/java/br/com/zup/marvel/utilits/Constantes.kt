...
const val NAME_ERROR_MESSAGE = "Por gentileze, informe o seu nome"
const val EMAIL_ERROR_MESSAGE = "Por gentileze, informe o seu e-mail"
const val PASSWORD_ERROR_MESSAGE = "Por gentileze, informe sua senha"
const val  CREATE_USER_ERROR_MESSAGE = "Ow No :(. Erro ao criar o usuário"
const val USERS_KEY = "USER_KEY"
const val LOGIN_ERROR_MESSAGE = "Opa, Algo deu errado! Não foi possível realizar o Login"